...
return new class extends Migration
{
    ...
    {
        Schema::create('bit_cells', function (Blueprint $table) {
            ...
            $table->tinyInteger('NowValue')->comment('當下數值')->index();
            $table->tinyInteger('HandTrigger')->default(99)->comment('有人為操控時狀態')->index();
            $table->tinyInteger('HandTriggerValue')->default(99)->comment('人為操控切換後數值')->index();
