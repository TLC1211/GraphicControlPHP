...
return new class extends Migration
{
    ...
    {
        Schema::create('v_words', function (Blueprint $table) {
            ...
            $table->integer('NowValue')->comment('當下數值')->index();
            $table->tinyInteger('HandTrigger')->default(99)->comment('有人為操控時狀態')->index();
            $table->integer('HandTriggerValue')->default(99)->comment('人為操控切換後數值')->index();
