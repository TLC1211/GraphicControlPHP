...
<div class="row mx-0 fixed-top title-bar" id="title_bar">
    <div class="menu">
        <button class="btn p-0" onclick="openNav()"><img src="../images/icon/menu.png"></button>
    </div>
    <h3 class="col-12 px-0">@yield('Title')</h3>
</div>

<div id="openSidebar" class="open_sidebar">
    <a href="javascript:void(0)" class="btn" onclick="closeNav()"><img src="../images/icon/close.png"></a>
